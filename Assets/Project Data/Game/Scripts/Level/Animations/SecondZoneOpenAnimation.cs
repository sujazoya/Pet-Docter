...
{
    public class SecondZoneOpenAnimation : ZoneOpenAnimation
    {
        [Header("Materials")]
        ...
        public override void OnZoneInitialised(Zone zone)
        {
            ...
            if (zone.IsOpened || zone.IsPermanentOpened)
            {
                ...
                if (disabledEnvironmentObject) { disabledEnvironmentObject.SetActive(false); }
            ...
            else
            {
                ...
                if (disabledEnvironmentObject) { disabledEnvironmentObject.SetActive(true); }
